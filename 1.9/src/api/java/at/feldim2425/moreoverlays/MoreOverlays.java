...
@Mod(modid = MoreOverlays.MOD_ID, version = MoreOverlays.VERSION, name = MoreOverlays.NAME, clientSideOnly = true, dependencies = "required-after:Forge@[12.16.0.1841,);", guiFactory = "at.feldim2425.moreoverlays.config.GuiFactory")
public class MoreOverlays {
	...
	//Temporarily here before forge fixes bugs.
