...
public class ClientProxy implements IProxy {
	...
	public void preInit(FMLPreInitializationEvent event){
		...
		if(Loader.isModLoaded(LightLevelOverlayReloaded.MODID) || Loader.isModLoaded(MoreOverlays.MOD_ID)) grid.addElement(llorToggle = new LightLevelOverlayToggleFEIUtil(Loader.isModLoaded(LightLevelOverlayReloaded.MODID), Loader.isModLoaded(MoreOverlays.MOD_ID)));
	}
