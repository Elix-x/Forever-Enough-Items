...
public class JEIOverrideConfigurationGui extends ElementalGuiScreen {
	...
	public void addElements(){
		add(new ButtonGuiElement("JEI", xPos, nextY, guiWidth - 4, 20, 2, 2, StatCollector.translateToLocal("fei.gui.override.jei.override.jei")){
		...
		StringGuiElement se;
		add(se = new StringGuiElement("Can Give Items", xPos, nextY + 12 - 8, 2, 2, StatCollector.translateToLocal("fei.gui.override.jei.override.cangiveitems") + " ", fontRendererObj, new RGBA(1f, 1f, 1f, 1f)));
		...
		add(se = new StringGuiElement("Can Delete Items Above Items List", xPos, nextY + 12 - 8, 2, 2, StatCollector.translateToLocal("fei.gui.override.jei.override.candeleteitemsaboveitemslist") + " ", fontRendererObj, new RGBA(1f, 1f, 1f, 1f)));
		...
		add(se = new StringGuiElement("Move Search Field To Center", xPos, nextY + 12 - 8, 2, 2, StatCollector.translateToLocal("fei.gui.override.jei.override.movesearchfieldtocenter") + " ", fontRendererObj, new RGBA(1f, 1f, 1f, 1f)));
		...
		add(se = new StringGuiElement("Search Field Width", xPos, nextY + 16 - 8, 2, 2, StatCollector.translateToLocal("fei.gui.override.jei.override.searchfieldwidth") + " ", fontRendererObj, new RGBA(1f, 1f, 1f, 1f)));
		...
		add(se = new StringGuiElement("Search Field Height", xPos, nextY + 16 - 8, 2, 2, StatCollector.translateToLocal("fei.gui.override.jei.override.searchfieldheight") + " ", fontRendererObj, new RGBA(1f, 1f, 1f, 1f)));
