...
public class FEIModsItemsDropdownSettingsGui extends ElementBasicSettingsGuiScreen {
	...
	protected void addElements(){
		...
		StringGuiElement s;
		add(s = new StringGuiElement("Folded Y Size", xPos, nextY + 16 - 8, 2, 2, StatCollector.translateToLocal("fei.gui.settings.dropdown.dropdownsize"), fontRendererObj, new RGBA(1f, 1f, 1f, 1f)));
