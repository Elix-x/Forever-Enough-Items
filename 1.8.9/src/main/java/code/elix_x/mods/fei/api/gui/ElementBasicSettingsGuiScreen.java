...
public class ElementBasicSettingsGuiScreen extends ElementalGuiScreen {
	...
	protected void addElements(){
		add(new ButtonGuiElement("Position And Size", xPos, nextY, guiWidth - 4, 20, 2, 2, StatCollector.translateToLocal("fei.gui.settings.possize")){
		...
		int bsw = Math.max(mc.fontRendererObj.getStringWidth(borderXS = StatCollector.translateToLocal("fei.gui.settings.borderx") + " "), mc.fontRendererObj.getStringWidth(borderYS = StatCollector.translateToLocal("fei.gui.settings.bordery") + " "));
		...
		add(new CenteredStringGuiElement("Background Color", xPos + guiWidth / 2, nextY + (20 - 8) / 2, 2, 2, StatCollector.translateToLocal("fei.gui.settings.backgroundcolor"), fontRendererObj, backgroundColor));
		nextY += 2 + 20 + 2;
		...
		add(new CenteredStringGuiElement("Text Color", xPos + guiWidth / 2, nextY + (20 - 8) / 2, 2, 2, StatCollector.translateToLocal("fei.gui.settings.textcolor"), fontRendererObj, textColor));
		nextY += 2 + 20 + 2;

		String tooltipBackground;
		bsw = fontRendererObj.getStringWidth(tooltipBackground = StatCollector.translateToLocal("fei.gui.settings.tooltipbackground") + " ");
