				...
				return new Runnable(){
					...
					public void run(){
						...
						if(FEIConfiguration.canLoadInventory(player)){
							...
							player.addChatMessage(new ChatComponentText(String.format(ChatFormatting.RED + StatCollector.translateToLocal("fei.lowlevel.inventorysaves"), FEIPermissionLevel.MODERATOR)));
						}
					}
