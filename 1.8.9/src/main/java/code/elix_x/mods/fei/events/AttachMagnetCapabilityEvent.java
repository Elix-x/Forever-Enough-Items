...
public class AttachMagnetCapabilityEvent {
	...
	public void attach(AttachCapabilitiesEvent.Entity event){
		if(event.getEntity() instanceof EntityPlayer) event.addCapability(new ResourceLocation(ForeverEnoughItemsBase.MODID, "magnet"), new ICapabilitySerializable<NBTTagByte>(){
			...
			public <T> T getCapability(Capability<T> capability, EnumFacing facing){
				return capability == MagnetCapability.CAPABILITY ? (T) instance : null;
			}
